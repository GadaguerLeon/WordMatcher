...
namespace WordUnscrambler
{
    class Program
    {
                ...
                do
                {
                    ...
                    switch (option.ToUpper())
                    {
                        case Constants.File:
                            ...
                            ExecuteScrambledWordsInFileOption();
                            break;
                        case Constants.Manual:
                            Console.Write(Constants.EnterScrambledWordsManually);
                            ExecuteScrambledWordsManuallyOption();
                            break;
                        default:
                    ...
                    do
                    {
                        ...
                        Console.WriteLine(Constants.OptionsForContinuingTheProgram);
                        continueDecision = (Console.ReadLine() ?? string.Empty);

                    } while (!continueDecision.Equals(Constants.Yes, StringComparison.OrdinalIgnoreCase) &&
                             !continueDecision.Equals(Constants.No));
        ...
        private static void ExecuteScrambledWordsManuallyOption()
        {
        ...
        private static void ExecuteScrambledWordsInFileOption()
        {
            try
            {
